...
#[derive(Debug, Clone)]
pub struct TokioTaskContext<T: Clone + Send + 'static, I: TaskId> {
    /// Task data storage
...
impl<T: Clone + Send + 'static, I: TaskId> TokioTaskContext<T, I> {
...
impl<T: Clone + Send + 'static, I: TaskId> Default for TokioTaskContext<T, I> {
    fn default() -> Self {
        Self::new()
    }
}
...
impl<T: Clone + Send + 'static, I: TaskId> ContextualizedTask<T, I> for TokioTaskContext<T, I> {
