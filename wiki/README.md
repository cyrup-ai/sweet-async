...
![screenshot](/Volumes/samsung_t9/projects/sweet_async/crates/sweet.async.wiki/static/assets/img/bg-masthead.jpg)
...
`static/assets/img/bg-sweet-async.png` in your own site.
